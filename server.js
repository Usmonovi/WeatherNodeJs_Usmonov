...
app.get('/izzat', async function(req, res) {
    ...
    if (moon_code == 0) {
        moon_code1 = "полнолуние"
    }
    if (moon_code > 0 && moon_code < 4) {
        moon_code1 = "убывающая Луна"
    }
    if (moon_code == 4) {
        moon_code1 = "последняя четверть Луны"
    }
    if (moon_code > 4 && moon_code < 8) {
        moon_code1 = "убывающая Луна"
    }
    if (moon_code == 8) {
        moon_code1 = "новолуние"
    }
    if (moon_code > 8 && moon_code < 12) {
        moon_code1 = "растущая Луна"
    }
    if (moon_code == 12) {
        moon_code1 = "первая четверть Луны"
    }
    if (moon_code > 13 && moon_code < 16) {
        moon_code1 = "растущая Луна"
    }
    const data = {
        title: 'laboratory',
